...
Die Absicherung des Bausteins Task Scheduling basiert auf dem _Standard OAuth2.0_ und nutzt hierfür den Baustein Security und dessen xref:security::konzept.adoc#aussensicht-der-komponente-security[Schnittstelle zur Authentifizierung].
